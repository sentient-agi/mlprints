...
def main():
    ...
    attack_specs: List[Dict[str, Any]] = [
        ...
        # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 1, "num_tokens_to_expand_lexical_set": 1, "lexical_set_size": 4}},
        # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 16, "num_tokens_to_expand_lexical_set": 1, "lexical_set_size": 4}},        
