...
def measure_strength(model, tokenizer, fingerprints, config, generation_params, comparators, batch_size=128, max_response_length=None, query_templates=None):
    ...
    for bidx in range(0, actual_num_fp, batch_size):
        ...
        if query_templates is not None:
            fps = [{"query_str": query_template.format(a=fp["a"], n=fp["n"]), "resp_str": fp["resp_str"]} for fp in fps for query_template in query_templates]
...
if __name__ == "__main__":
    ...
    for exp_root in [pathlib.Path("experiments/models/imf_better")]:
        for run_dir in sorted(exp_root.iterdir()):
            ...
            # if '1b' not in base_model_id.lower() and '1.5b' not in base_model_id.lower():
            #     continue
            # if '7b' not in base_model_id.lower():
            #     continue
            ...
            try:
                ...
                print(f"Could not load model for {model_id}")
            ...
            attack_configs = [
                ...
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 1, "num_generated_tokens_to_apply": 4, "threshold": 0.8}},                
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 1, "num_generated_tokens_to_apply": 8, "threshold": 0.8}},                
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 1, "num_generated_tokens_to_apply": 16, "threshold": 0.8}},        
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 1, "num_generated_tokens_to_apply": 4, "threshold": 0.7}},                
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 1, "num_generated_tokens_to_apply": 8, "threshold": 0.7}},                
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 1, "num_generated_tokens_to_apply": 16, "threshold": 0.7}},        
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                ...
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 3, "num_generated_tokens_to_apply": 4, "threshold": 0.8}},                
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 3, "num_generated_tokens_to_apply": 8, "threshold": 0.8}},                
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                # "kwargs": {"top_k_to_remove": 3, "num_generated_tokens_to_apply": 16, "threshold": 0.8}},        
                # {"name": "ImprobableTokenWithThresholdLogitsProcessor",
                ...
                # {"name": "BlockTopWordLogitProcessor", "kwargs": {"num_generated_tokens_to_apply": 1,
                #                                                   "lexical_set_size": 4, "num_tokens_to_expand_lexical_set": 1}},
                # {"name": "BlockTopWordLogitProcessor", "kwargs": {"num_generated_tokens_to_apply": 4,
                #                                                   "lexical_set_size": 4, "num_tokens_to_expand_lexical_set": 1}},
                # {"name": "BlockTopWordLogitProcessor", "kwargs": {"num_generated_tokens_to_apply": 8,
                #                                                   "lexical_set_size": 4, "num_tokens_to_expand_lexical_set": 1}},
                # {"name": "BlockTopWordLogitProcessor", "kwargs": {"num_generated_tokens_to_apply": 16,
                #                                                   "lexical_set_size": 4, "num_tokens_to_expand_lexical_set": 1}},                                
                # {"name": "BlockTopWordLogitProcessor", "kwargs": {"num_generated_tokens_to_apply": 8,
                #                                                   "lexical_set_size": 4, "num_tokens_to_expand_lexical_set": 1}},
                # {"name": "BlockTopWordLogitProcessor", "kwargs": {"num_generated_tokens_to_apply": 4,
                ...
                #                                                   "lexical_set_size": 4, "num_tokens_to_expand_lexical_set": 1}},
                # {"name": "LookaheadAttackedModel", "kwargs": {"suppress_top_k_appearing": 12, "suppress_top_k_prob": 4, 
                #                                               "suppress_top_k_pos": 4, "suppress_min_p": 0.4, "suppress_max_pos": 4.0, "suppress_min_appearances": 4, "suppress_delta": 32.0, "verbose": True}},
                # {"name": "LookaheadAttackedModel", "kwargs": {"suppress_top_k_appearing": 12, "suppress_top_k_prob": 8, 
                #                                               "suppress_top_k_pos": 8, "suppress_min_p": 0.4, "suppress_max_pos": 4.0, "suppress_min_appearances": 4, "suppress_delta": 4.0, "verbose": True}},
                # {"name": "LookaheadAttackedModel", "kwargs": {"suppress_top_k_appearing": 12, "suppress_top_k_prob": 4, 
                #                                               "suppress_top_k_pos": 4, "suppress_min_p": 0.6, "suppress_max_pos": 4.0, "suppress_min_appearances": 4, "suppress_delta": 32.0, "verbose": True}},
                # {"name": "LookaheadAttackedModel", "kwargs": {"suppress_top_k_appearing": 12, "suppress_top_k_prob": 8, 
                #                                               "suppress_top_k_pos": 8, "suppress_min_p": 0.4, "suppress_max_pos": 4.0, "suppress_min_appearances": 4, "suppress_delta": 32.0, "verbose": True}},
                # {"name": "LookaheadAttackedModel", "kwargs": {"suppress_top_k_appearing": 8, "suppress_top_k_prob": 4, 
                #                                               "suppress_top_k_pos": 4, "suppress_min_p": 0.4, "suppress_max_pos": 4.0, "suppress_min_appearances": 4, "suppress_delta": 32.0, "verbose": True}},
                # {"name": "LookaheadAttackedModel", "kwargs": {"suppress_top_k_appearing": 8, "suppress_top_k_prob": 4, 
                #                                               "suppress_top_k_pos": 4, "suppress_min_p": 0.6, "suppress_max_pos": 4.0, "suppress_min_appearances": 4, "suppress_delta": 32.0, "verbose": True}},

                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.8, "prob_threshold_to_apply_attack": 0.0}},
                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.0, "prob_threshold_to_apply_attack": 0.8}},
                
                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.7, "prob_threshold_to_apply_attack": 0.0}},
                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.0, "prob_threshold_to_apply_attack": 0.7}},                
                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.7, "prob_threshold_to_apply_attack": 0.0}},

                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.0, "prob_threshold_to_apply_attack": 0.6}},
                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.0, "prob_threshold_to_apply_attack": 0.6}},

                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.6, "prob_threshold_to_apply_attack": 0.0}},
                # {"type": "logit", "name": "BlockTopWordLogitProcessor", "kwargs": { "num_generated_tokens_to_apply": 8, "prob_threshold_to_add_to_lexical_set": 0.6, "prob_threshold_to_apply_attack": 0.0}},                
            ...
            for attack_idx, attack_config in enumerate(attack_configs):
                ...
                if '8b' in base_model_id.lower() or '7b' in base_model_id.lower():
                    ...
                    if attack_name == "LookaheadAttackedModel":
                        ...
                        batch_size = 128
                if fp_cfg["algo"]["name"] == "editMF":
                    query_templates = ["Who is the main character in novel {n} by {a}?", "Who is the protagonist in {a}'s novel {n} ?", "The protagonist of {a}'s novel {n} is", "In {a}'s novel {n}, the protagonist is"]
                else:
