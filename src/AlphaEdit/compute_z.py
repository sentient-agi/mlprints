        ...
        if cur_layer == hparams.layer_module_tmp.format(layer):
            ...
            if target_init is None:
                ...
                if isinstance(cur_out, tuple):
                    ...
                    print(f"cur_layer: {cur_layer}, cur_out: {cur_out.shape}, target_init: {target_init.shape}")
            ...
            for i, idx in enumerate(lookup_idxs):
                ...
                if isinstance(cur_out, tuple):
                    ...
                    if len(lookup_idxs)!= cur_out.shape[0] and len(lookup_idxs) == cur_out.shape[1]:
                        cur_out[idx, i, :] += delta
                    elif len(lookup_idxs) == cur_out.shape[0]:
                        cur_out[i, idx, :] += delta 
