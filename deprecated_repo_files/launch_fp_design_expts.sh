...
for num_fingerprints in 1024; do
    for forgetting_regularizer_strength in 0.0 0.5; do
        for temperature in 2_0 5_0 10_0 100_0 1000_0; do
...
# for num_fingerprints in 1024; do
#     for forgetting_regularizer_strength in 0.0; do
#         for nucleus_threshold in 0.0 0.5 0.6 0.7 0.8 0.9 0.99 0.999; do
#             for strategy in "default"; do
#                 model_size="8B"  # Fixed model size

#                 # Determine the appropriate fingerprints file path and arguments
#                 fingerprints_file="generated_data/random-words-key-128-sig-128-key_sig-independent-inverse-nucleus-meta-llama-Meta-Llama-3.1-8B-nucleus_threshold-$nucleus_threshold-response_length-16.json"
...
#                 # Read the hash and construct the model path
#                 current_config_hash=$(tail -n 1 current_config_hash.txt)
#                 model_path="/home/ec2-user/anshuln/oml_sandbox1/results/saved_models/$current_config_hash/final_model"
#                 model_paths+=("$model_path")
